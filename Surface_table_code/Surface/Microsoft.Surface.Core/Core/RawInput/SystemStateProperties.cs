...
// Type: Microsoft.Surface.Core.RawInput.SystemStateProperties
...
{
  internal class SystemStateProperties
  {
    private readonly bool isConnected;

    public bool IsConnected => this.isConnected;

    public SystemStateProperties(bool isConnected) => this.isConnected = isConnected;
  }
}
